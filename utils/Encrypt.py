...
if  __name__ =='__main__':
	...
	#encrypt_file('C:\Users\StandardUser\Desktop\iSECProject\Sneha_Projects\Box\useruploads\snehaPavan.jpg',encryptionkey,True)
	decrypt_file('C:\Users\StandardUser\Desktop\iSECProject\Sneha_Projects\Box\useruploads\snehaPavan_encrypted.jpg',encryptionkey,True)
#	print 'EncryptionKey :' + encryptionkey
#	cipher = encrypt(encryptionkey, 'pavanwalvekarrocks')
#	print  'PlainTest : pavanwalvekarrocks CipherText :' + cipher
