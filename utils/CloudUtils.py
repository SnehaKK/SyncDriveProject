...
if  __name__ =='__main__':
	parentFilePath = 'C:\Users\StandardUser\Desktop\iSECProject\Sneha_Projects\Box\useruploads'
	splitNum = 4
	parentFileName = 'snehaPavan.jpg'
	splitsvilla(parentFilePath,parentFileName,splitNum)
	#marriage(os.path.join(parentFilePath,'snehaPavan_4_0_jpg.SDPart'))
